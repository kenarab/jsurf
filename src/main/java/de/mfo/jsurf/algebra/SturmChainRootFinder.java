...
class MyPolynomial extends SturmPolynomial
{
	...
	{ // the illegal case
	    if (degB == -1)
	    {
		throw new IllegalArgumentException("Cannot divide by constant polynomials");
	    }
	    else
	    {
...
class Solve
{
     ...
     * @return the zero
     */
    public static double solve(SturmPolynomial poly, int num, double lower, double upper, double precision, int iterations)
    {
     ...
     * @return the zero
     */
    public static double solve(SturmPolynomial poly, int num, double lower, double upper, int iterations)
    {
