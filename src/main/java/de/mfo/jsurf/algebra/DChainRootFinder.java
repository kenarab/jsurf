...
public class DChainRootFinder implements RealRootFinder
{
	...
	{
	    return (dividerIsNotNaN && _findFirstRootIn(searchStructs, startWith - 1, divider, largestPossibleRoot, root)) || ((searchUpperBound == largestPossibleRoot && startWith != 0) && _findFirstRootIn(searchStructs, startWith - 1, largestPossibleRoot, largestPossibleRoot, root));
	}
    }
